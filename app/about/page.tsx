...
const team = [
  {
    ...
    bio: "Former lead designer at a AAA studio. Started Proper Studios to make the games big publishers wouldn't greenlight.",
    image:
  ...
  },
  {
    ...
    bio: "Engine programmer with 20 years in the industry. Built the rendering tech that powers every Proper Studios title.",
    image:
      'https://images.pexels.com/photos/3777943/pexels-photo-3777943.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    name: 'Aisha Okonkwo',
    role: 'Art Director',
    bio: "Concept artist turned art lead. Defines the visual identity of every world we build, from neon cities to alien ruins.",
    image:
      'https://images.pexels.com/photos/3777943/pexels-photo-3777943.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    ...
    bio: "Systems designer obsessed with emergent gameplay. Believes the best stories are the ones players tell themselves.",
    image:
      'https://images.pexels.com/photos/3777943/pexels-photo-3777943.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
];
          ...
          {team.map((member) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="font-mono-retro mt-2 text-lg text-foreground/80">
                  {member.role}
                </p>
                <p className="font-mono-retro mt-3 text-base leading-relaxed text-muted-foreground">
                  {member.bio}
                </p>
              </div>
            </div>
