          ...
          {featured.map((game) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  <h3 className={`font-retro text-sm ${a.text} ${a.glow}`}>
                    {game.title}
                  </h3>
                  <p className="font-mono-retro mt-2 text-lg text-muted-foreground">
                    {game.tagline}
                  </p>
                  <div className="mt-4 flex items-center gap-2 font-mono-retro text-base text-primary opacity-0 transition-opacity group-hover:opacity-100">
